...
function Card({
  ...
  return (
    <div
      className={`rounded-[30px] border border-slate-200 bg-white shadow-[0_14px_45px_rgba(15,23,42,0.08)] ${className}`}
    >
      {children}
    </div>
  );
...
export default function ESLAudioPromptApp() {
  ...
  const [newPromptColor, setNewPromptColor] = useState("#be185d");
  ...
  const displayedPromptColor = safeColor(activePrompt?.prompt_color, "#be185d");
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-violet-50 via-pink-50 to-sky-50 p-6 text-slate-900">
      <div className="mx-auto max-w-7xl space-y-8">
        <div className="rounded-[30px] border border-white/70 bg-white/80 p-6 shadow-[0_18px_50px_rgba(91,33,182,0.10)]">
                ...
                <div className="rounded-[24px] border border-violet-100 bg-violet-50/50 p-4">
                  ...
                  <div
                    ...
                    style={{
                      ...
                      borderColor: `${safeColor(newPromptColor, "#be185d")}44`,
                    }}
                  >
                    <div className="mb-3 inline-flex items-center rounded-full bg-violet-700 px-4 py-1 text-sm font-black uppercase tracking-wide text-white">
                      Speaking task
                    </div>
                    ...
                    <div
                      className="mt-3 text-3xl font-black leading-snug"
                      style={{ color: safeColor(newPromptColor, "#be185d") }}
                    >
